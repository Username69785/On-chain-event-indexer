...
- [х] Сделать разделение логов по воркерам
- [х] Жестче проверять адрес: вынести проверку в отдельную функцию и валидировать перед передачей адреса воркеру
- [ ] Сделать продолжение индексации адресов с индексом indexing
- [ ] Начать строить графики:
  - [ ] Посерчить инфу
  - [ ] Написать функцию для генерация одного графика
  - [ ] Свяхать бекенд с фронтендом
- [ ] 
- [ ] 
- [ ] Добавить привязку к времени. “Тот же адрес в другой день”
- [ ] 
...
- [x] Реализовать работу одного воркера
- [x] Реализовать полноценное использование таблицы processing_data
- [x] Брать адрес из БД

### 22.02

- [х] Глобально на RPC поставить governor + Semaphore (ограничение RPS и in-flight).
- [х] Убрать автообновления сайта после отправки адреса 
