...
- [ ] Разобраться с взаимодействием фронтенда и бекендаж
- [ ] Реализовать передачу данных с фронтенда в бекенд и наоборот
- [ ] Создать таблицу для сохранения данных для обрабодки:
